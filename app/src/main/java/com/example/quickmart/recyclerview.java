...
public class recyclerview extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.Contact_Us:
                ...
                Intent intent2=new Intent(recyclerview.this,ContactUs.class);
